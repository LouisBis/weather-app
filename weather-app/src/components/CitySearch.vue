    ...
    <div class="flex flex-col p-12 h-auto max-w-xl mx-auto">
        ...
        <form @submit.prevent="fetchWeather()">
            ...
            <div class="flex flex-row">
                ...
                <button
                    class="bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded dark:bg-orange-600 dark:border-orange-800 dark:hover:bg-orange-500  dark:hover:border-orange-700">
                    Search
                </button>
            </div>
        </form>
